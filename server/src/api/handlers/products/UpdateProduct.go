...
func UpdateProduct(w http.ResponseWriter, req *http.Request) {
	...
	// if count == 0 {
	// 	utils.WriteJSON(w, http.StatusNotFound, "This product does not exist. Please try again.")
	// 	return
	// }
	...
	// 	}
	// 	if count >= 1 {
	// 		utils.WriteJSON(w, http.StatusBadRequest, "Product Sku already exists. Please try again.")
	// 		return
	// 	}
	// }
	...
	// if brandCount == 0 {
	// 	utils.WriteJSON(w, http.StatusNotFound, "Brand name does not exist. Please try again.")
	// 	return
	// }
	// if colourCount == 0 {
	// 	utils.WriteJSON(w, http.StatusNotFound, "Colour does not exist. Please try again.")
	// 	return
	// }
	// if categoryCount == 0 {
	// 	utils.WriteJSON(w, http.StatusNotFound, "Category does not exist. Please try again.")
	// 	return
	// }
	...
	// 		}
	// 		if count == 0 {
	// 			utils.WriteJSON(w, http.StatusNotFound, sizeName+" size name does not exist. Please create this size or try again.")
	// 			return
	// 		}
	...
	// 		}
	// 		if count == 0 {
	// 			utils.WriteJSON(w, http.StatusNotFound, sizeName+" size name does not exist for this product. Please try again.")
	// 			return
	// 		}
	// 	}
	// }
	...
	// utils.WriteJSON(w, http.StatusOK, "Successfully updated the product!")
}
