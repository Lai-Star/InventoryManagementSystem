...
func Login(w http.ResponseWriter, req *http.Request) {
	...
	// 	utils.WriteJSON(w, http.StatusUnauthorized, "You have entered an incorrect username and/or password. Please try again.")
	// 	return
	// }
	...
	// }
	// if dbStatus != 1 {
	// 	utils.WriteJSON(w, http.StatusForbidden, "Your account has been disabled. Please contact the IMS Administrator.")
	// 	return
	// }
